    ...
    >
      <div style={{ display: "flex", alignItems: "center", gap: 20, marginBottom: 20 }}>
        <Image
          width={100}
          src={student.image}
          style={{ borderRadius: "50%", border: "2px solid #1E9FD9" }}
        />
        <div>
          <Title level={3} style={{ color: "#1E9FD9", margin: 0 }}>
            {student.fullName}
          </Title>
      ...
      <Descriptions bordered column={2} size="middle">
        <Descriptions.Item label="Student ID">
          <Text strong style={{ color: "#1E9FD9" }}>{student.studentIdNumber}</Text>
        </Descriptions.Item>
        ...
        <Descriptions.Item label="Gender">
          <Text strong style={{ color: "#1E9FD9" }}>{student.genderName}</Text>
        </Descriptions.Item>
        <Descriptions.Item label="Status">{student.studentStatusName}</Descriptions.Item>
